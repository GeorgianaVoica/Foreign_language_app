...
public class L1IntermediateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l1_intermediate);

        Drawable image = getResources().getDrawable(R.drawable.medal3);
        ImageView imageView = new ImageView(this);
        imageView.setImageDrawable(image);


        bFinnishL1B = findViewById(R.id.bFinnishL1I);
    ...
    private void getComponents() {
        ...
        tvQ1L1B = findViewById(R.id.tvQ1L1I);
        tvQ2L1B = findViewById(R.id.tvQ2L1I);
        tvQ3L1B = findViewById(R.id.tvQ3L1I);
        tvQ4L1B = findViewById(R.id.textViewQ4L1I);
        tvQ5L1B = findViewById(R.id.textViewQ5L1I);

        db = FirebaseFirestore.getInstance();
        auth = FirebaseAuth.getInstance();
        userRef = db.collection("users").document(auth.getCurrentUser().getUid());

        bword1L1B = findViewById(R.id.bword1L1I);
        bword2L1B = findViewById(R.id.bword2L1I);
        bword3L1B = findViewById(R.id.bword3L1I);
        bword4L1B = findViewById(R.id.bword4L1I);

        raspunsQ2L1B = findViewById(R.id.raspunsQ2L1I);

        imgbReplayL1B = findViewById(R.id.imageButtonReplayL1I);

        rgQ1L1B = findViewById(R.id.rgQ1L1I);
        rgChkL1B = findViewById(R.id. rgChkL1I);
        rg4L1B = findViewById(R.id.rg4L1I);
        rg5L1B = findViewById(R.id.rg5L1I);

        rb2 = findViewById(R.id.rb2Q1L1I);
        rb1Q4 = findViewById(R.id.rb1Q4L1I);
        rb3Q5 = findViewById(R.id.rb3Q5L1I);

        cb2 = findViewById(R.id.checkBox2L1I);
    }
