...
public class L2AdvancedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l2_advanced);
        ...
        bFinnishL1B = findViewById(R.id.bFinnishL2A);
    ...
    private void getComponents() {
        ...
        tvQ1L1B = findViewById(R.id.tvQ1L2A);
        tvQ2L1B = findViewById(R.id.tvQ2L2A);
        tvQ3L1B = findViewById(R.id.tvQ3L2A);
        tvQ4L1B = findViewById(R.id.textViewQ4L2A);
        tvQ5L1B = findViewById(R.id.textViewQ5L2A);

        db = FirebaseFirestore.getInstance();
        auth = FirebaseAuth.getInstance();
        userRef = db.collection("users").document(auth.getCurrentUser().getUid());

        bword1L1B = findViewById(R.id.bword1L2A);
        bword2L1B = findViewById(R.id.bword2L2A);
        bword3L1B = findViewById(R.id.bword3L2A);
        bword4L1B = findViewById(R.id.bword4L2A);

        raspunsQ2L1B = findViewById(R.id.raspunsQ2L2A);

        imgbReplayL1B = findViewById(R.id.imageButtonReplayL2A);

        rgQ1L1B = findViewById(R.id.rgQ1L2A);
        rgChkL1B = findViewById(R.id. rgChkL2A);
        rg4L1B = findViewById(R.id.rg4L2A);
        rg5L1B = findViewById(R.id.rg5L2A);

        rb2 = findViewById(R.id.rb2Q1L2A);
        rb1Q4 = findViewById(R.id.rb1Q4L2A);
        rb3Q5 = findViewById(R.id.rb3Q5L2A);
