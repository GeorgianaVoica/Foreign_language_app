...
public class L2BeginnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l2_beginner);
        ...
        bFinnishL1B = findViewById(R.id.bFinnishL2B);
        ...
        userRef.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                Query query = db.collection("lessons").whereEqualTo("level", user.getLevel()).whereEqualTo("noLesson", 2);
    ...
    private void getComponents() {
        ...
        tvQ1L1B = findViewById(R.id.tvQ1L2B);
        tvQ2L1B = findViewById(R.id.tvQ2L2B);
        tvQ3L1B = findViewById(R.id.tvQ3L2B);
        tvQ4L1B = findViewById(R.id.textViewQ4L2B);
        tvQ5L1B = findViewById(R.id.textViewQ5L2B);

        db = FirebaseFirestore.getInstance();
        auth = FirebaseAuth.getInstance();
        userRef = db.collection("users").document(auth.getCurrentUser().getUid());

        bword1L1B = findViewById(R.id.bword1L2B);
        bword2L1B = findViewById(R.id.bword2L2B);
        bword3L1B = findViewById(R.id.bword3L2B);
        bword4L1B = findViewById(R.id.bword4L2B);

        raspunsQ2L1B = findViewById(R.id.raspunsQ2L2B);

        imgbReplayL1B = findViewById(R.id.imageButtonReplayL2B);

        rgQ1L1B = findViewById(R.id.rgQ1L2B);
        rgChkL1B = findViewById(R.id. rgChkL2B);
        rg4L1B = findViewById(R.id.rg4L2B);
        rg5L1B = findViewById(R.id.rg5L2B);

        rb2 = findViewById(R.id.rb2Q1L2B);
        rb1Q4 = findViewById(R.id.rb1Q4L2B);
        rb3Q5 = findViewById(R.id.rb3Q5L2B);

        cb2 = findViewById(R.id.checkBox2L2A);
    }
